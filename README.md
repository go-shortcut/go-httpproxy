...
[![GoDoc](https://godoc.org/github.com/go-shortcut/httpproxy?status.svg)](https://godoc.org/github.com/go-shortcut/httpproxy)
...
```sh
go get -u github.com/go-shortcut/httpproxy/v2
```
